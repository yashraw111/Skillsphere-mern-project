...
export default function SignUpForm() {
  ...
  const onSubmit = (data) => {
    alert('Sign up successful! Account created for: ' + data.email);
    // Backend call yaha hota hai in real use
    console.log(data);
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            Already have an account? <a href={RouterSignIn} className="font-medium text-indigo-600 hover:text-indigo-500">Sign in</a>
          </p>
        </div>
      </div>
    </div>
